Calculating location-specific biodiversity footprints for food using a combination of FAO stat consumption data, Resource Trade Earth data, and BIOVALENT footprint values.
